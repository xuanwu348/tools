...
class Screen(object):
    ...
    help_string_1 = "(W)Up (S)Down (A)Left (D)Right"
    help_string_2 = "   (R)Restart (Q)Exit"
    over_string = "~~~~~~~~~" + "\n" + "       Game Over"+ "\n" + "~~~~~~~~~"
    win_string = "~~~~~~~~~" + "\n" + "YOU WIN" + "\n" + "~~~~~~~~~"
    ...
    def draw(self):
        ...
        if self.win:
            ...
            if self.over:
                ...
                self.cast(self.help_string_1)
        self.cast(self.help_string_2)

class GameManager(object):
    def __init__(self, size=4, win_num=win_num):
        self.size = size
...
if __name__ == "__main__":
    dis.dis(curses.wrapper(GameManager()))
